...
local fs = prequire(_package_dir .. ".path.fs")
...
local each = require(_package_dir .. ".path.findfile").load(function(opt)
...
local function make_module()
  local M = require(_package_dir .. ".path.module")
