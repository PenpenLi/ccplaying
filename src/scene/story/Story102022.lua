...
function Story:ctor( callback )
    ...
    local sunwukong = self:CreatePerson(SCREEN_WIDTH-500, 200, 1018, wukong_skins)
    ...
    self.message = {
		{icon = icon_sunwukong,dir = 1, speak = "孙悟空", msg = "你是自己说呢，还是我逼你说呢！"},
		{icon = icon_xiaoyaoguai,dir = 2, speak = "小妖怪", msg = "哎呀，要死要死要死要死…"},
		{icon = icon_xiaoyaoguai,dir = 2, speak = "小妖怪", msg = "不关我的事呀，是土地公放错路牌了的啦！"},
		{icon = icon_wanjia, dir = 1, speak = GameCache.Avatar.Name .."", msg = "唉，那个老糊涂…"},
    }
    ...
    self:AddInitEndEvent(function (  )
		...
		sunwukong:setAnimation(0, "atk3", true)
		-- sunwukong:setAnimation(0, "idle", true)
		wanjia:setAnimation(0, "idle", true)
		xiaoyaoguai:setAnimation(0, "hit", true)
    ...
    self:AddDialogEndEvent(function ( eventname, hua )
        ...
        if hua == self.message[1].msg then
			self:WaitToDialog(0.2)
			self:Emoji(xiaoyaoguai, jingkong)
