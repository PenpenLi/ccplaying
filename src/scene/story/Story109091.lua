...
function Story:ctor( callback )
    ...
    self.message = {
		{icon = icon_wanjia, dir = 1, speak = GameCache.Avatar.Name .."", msg = "呼，我们终于走（gun）出来啦！"},
		{icon = icon_tianwang,dir = 2, speak = "托塔天王", msg = "那咱们现在怎么办？"},
		{icon = icon_wanjia, dir = 1, speak = GameCache.Avatar.Name .."", msg = "去龙宫！"},
    }
    ...
    self:AddInitEndEvent(function (  )
		...
		local go = cc.MoveTo:create(3.5, cc.p(650,200))
